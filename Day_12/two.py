...
while True:
	...
	for j in range(3):
			if (periods[j] == 0
				and moons[0][0][j] == original_state[0][0][j] and moons[0][1][j] == original_state[0][1][j]
				and moons[1][0][j] == original_state[1][0][j] and moons[1][1][j] == original_state[1][1][j]
				and moons[2][0][j] == original_state[2][0][j] and moons[2][1][j] == original_state[2][1][j]
				and moons[3][0][j] == original_state[3][0][j] and moons[3][1][j] == original_state[3][1][j]):
				periods[j] = steps
